...
from my_tutor.exceptions import LessonAlreadyExistError, StudentAlreadyHasLesson, TutorAlreadyHasLesson
...
async def add_lesson(lesson_data: AddLessonRequest, session: AsyncSession = Depends(get_db_session)) -> AddLessonResponse:
    ...
    except (LessonAlreadyExistError, TutorAlreadyHasLesson, StudentAlreadyHasLesson) as e:
